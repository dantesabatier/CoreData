...
/**
 * @var string Key to attempt to create the mapping model automatically. The corresponding value is a bool. If is true and the value of the MigratePersistentStoresAutomaticallyOption is true, the coordinator will attempt to infer a mapping model if none can be found.
 */
