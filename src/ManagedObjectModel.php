...
final class ManagedObjectModel extends ObjectClass implements IteratorAggregate, Countable
{
    ...
    {
        return ManagedObjectModel::merging($bundles->compactMap(fn(Bundle $bundle): ?ManagedObjectModel => (($name = $bundle->object(kCFBundleNameKey)) && ($url = ManagedObjectModelBundle::urlForModelNamed($name, $bundle))) ? new ManagedObjectModel($url) : null), $metadata);
    }
