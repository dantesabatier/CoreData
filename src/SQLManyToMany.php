...
final class SQLManyToMany extends SQLRelationship
{
    ...
    private(set) string $inverseColumnName {
        get => $this->inverseColumnName ??= ($this->inverseManyToMany->columnName === $this->columnName) ? "{$this->inverseManyToMany->columnName}_2" : $this->inverseManyToMany->columnName;
    }
    ...
    private(set) string $inverseOrderColumnName {
        get => $this->inverseOrderColumnName ??= $this->columnNames[1];
    }
