...
class BatchInsertRequest extends PersistentStoreRequest
{
     ...
     * @param Closure(Dictionary<mixed>): bool|null $dictionaryHandler A closure that provides a dictionary for your app to insert data into.
     ...
     * @param ArrayClass<Dictionary<mixed>>|ArrayClass<ManagedObject>|null $objectsToInsert An array of dictionaries that represents the objects to insert with the keys as attribute names and their assigned values.
