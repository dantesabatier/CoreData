...
class BatchInsertRequest extends PersistentStoreRequest
{
     ...
     * @param ArrayClass<Dictionary>|null $objectsToInsert An array of dictionaries that represents the objects to insert with the keys as attribute names and their assigned values.
