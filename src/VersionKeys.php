...
/** @var string Key to represent the version identifiers for the model used to create the store. If you add your own annotations to a model's version identifier (see {@see ManagedObjectModel::$versionIdentifiers}), they are stored in the persistent store's metadata. You can use this key to retrieve the identifiers from the metadata dictionaries available from PersistentStore ({@see PersistentStore::$metadata}) and PersistentStoreCoordinator ({@see PersistentStoreCoordinator::metadata()}) and related methods). The corresponding value is a Foundation collection (an ArrayClass or Set object). */
