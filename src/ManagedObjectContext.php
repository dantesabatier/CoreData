...
final class ManagedObjectContext extends ObjectClass
{
    ...
    {
        $registeredObject = $this->byHashAssociationTable->valueForKey((string)$objectID);
    ...
    public function rollback(): void
    {
        foreach ($this->updatedObjects as $updatedObject) {
            $updatedObject->rollbackChangesToStore();
        }
        $this->resetState();
    }
