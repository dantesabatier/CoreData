...
/** @var bool There is a bug where the object graph can become partially corrupted when using sort descriptors, this is because in order for {@see SQLFetchRequestContext::executeRequestCore()} to be able to add new leaves to the tree it needs to check the objectID column and with sort descriptors enabled this column may be retrieved in a different order. */
