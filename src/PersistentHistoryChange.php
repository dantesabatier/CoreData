...
final class PersistentHistoryChange extends ObjectClass
{
    ...
    {
        return new Dictionary(["changeID" => $this->changeID, "changeType" => $this->changeType, "entityName" => $this->changedObjectID->entity->name, "changedObjectID" => $this->changedObjectID, "tombstone" => $this->tombstone, "updatedProperties" => $this->updatedProperties?->map(fn(PropertyDescription $property): string => $property->name)]);
    }
}
